...
const loadWords = ["بنجهز لك الدنيا ثواني...", "معلش الناس لسه شغالة ع المفاجاة...", "خلصو تحيا مصر جاهزة يلا بينا..."]
...
wrongButtons.forEach(button => {
    button.addEventListener("click", () => {
        if (button.parentElement.id === "page3") {
            ...
            alert("سمعت اقاويل انك بتكلمي حد فممكن عشان كده ع العموم اخرجي وقوليلي ردك");
        } else if (button.parentElement.id === "page6") {
